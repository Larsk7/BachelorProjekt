...
function filterLehrDt(array $data): array {
    $filteredData = [];
    ...
    error_log("Nach Phase 5 (Filterung Lehr). Anzahl Zeilen: " . count($filteredData));
    ...
    error_log("Nach Phase 5 (Sortierung Lehr). Finale Zeilen: " . count($filteredData));
